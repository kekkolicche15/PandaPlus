...
#define DEVSTARTADDR   0x10000054
...
//I terminali contano come due dispositivi
#define EXTERNAL_DEVS_NO            (N_EXT_IL+1)*N_DEV_PER_IL

#define TERM0ADDR                   0x10000254
#define TERMSTATMASK                0xFF

#define DEV_READY                   1
#define TERM_STATUS(status)         (status & 0xFF)
#define CHAR_RECV                   5
#define CHAR_TRANSM                 5
#define HAS_TERM_TRANSM(line, term) (line==IL_TERMINAL && ((((termreg_t*)term)->transm_status & TERMSTATMASK)) == CHAR_TRANSM)
#define RECV_OFFSET                 0
#define TRANSM_OFFSET               2
